...
class dpuGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
        ...
        """
        assert(n_blocks >= 0)
        super(dpuGenerator, self).__init__()
        ...
        model += DPN(ngf, k_r=96, groups=32, k_sec=(3, 4, 20, 3), inc_sec=(16, 32, 24, 128))
...
class InputBlock(nn.Module):
    def __init__(self, num_init_features, kernel_size=7,
        ...
        self.conv = nn.Conv2d(
            256, num_init_features, kernel_size=kernel_size, stride=2, padding=padding, bias=False)
